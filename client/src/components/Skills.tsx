  ...
  return (
    <section id="skills" className="py-16 lg:py-20 section-gradient">
      <div className="container mx-auto px-4">
        ...
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto auto-rows-fr"
        ...
        >
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              <div 
                className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-5 gradient-border hover-grow h-full flex flex-col relative"
              >
